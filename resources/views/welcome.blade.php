    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Vous voulez maîtriser Laravel ?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Apprenez à créer un Saas (Software As A Service) en partant de zéro !
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Créez votre propre Saas avec les fonctionnalités essentielles !
          </p>
    ...
    <section class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 py-12">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
              Authentification Sociale
            </h3>
            <p class="text-gray-600 mb-8">
              Facilitez la vie des utilisateurs, en leur permettant de s'authentifier via Github, Google, Facebook, etc.
              <br />
          </div>
          <div class="w-full sm:w-1/2 p-6">
            <img class="w-full h-full mx-auto" src="img\authentification_secure_login.png" alt="">
          </div>
        </div>
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
        
          <div class="w-full sm:w-1/2 py-8">
          <img class="w-full h-full mx-auto" src="img\stripe_payments.png" />
          ...
          <div class="w-full sm:w-1/2 py-8">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                Apprenez à intégrer le paiement via Stripe.
                <br>
                Paramétrer Laravel et Stripe, tout apprendre devient facile !
                <br />
            </div>
          </div>
        </div>
